...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["g"] = scrollIntoView;
/* harmony export (immutable) */ __webpack_exports__["f"] = applyRange;
/* harmony export (immutable) */ __webpack_exports__["e"] = getRange;
/* harmony export (immutable) */ __webpack_exports__["a"] = getAtAndIndex;
/* harmony export (immutable) */ __webpack_exports__["c"] = getOffset;
/* harmony export (immutable) */ __webpack_exports__["h"] = closest;
/* harmony export (immutable) */ __webpack_exports__["d"] = getPrecedingRange;
...
function insertText(text, ta) {
  if (ta) {
    var cut = ta.selectionStart;
    ta.value = ta.value.slice(0, cut) + text + ta.value.slice(cut);
    var end = cut + text.length;
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    style: function style() {
      if (this.atwho) {
        ...
        if (wrap) {
          var offset = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["c" /* getOffset */])(wrap);
          var left = x + window.pageXOffset - offset.left + 'px';
          var top = y + window.pageYOffset - offset.top + 'px';
  ...
  methods: {
    ...
    handleDelete: function handleDelete(e) {
      var range = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["d" /* getPrecedingRange */])();
      if (range) {
        ...
        if (index > -1) {
          var chunk = text.slice(index + at.length, -1);
          ...
          if (has) {
            e.preventDefault();
            e.stopPropagation();
            var r = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["e" /* getRange */])();
            if (r) {
              r.setStart(r.endContainer, index);
              r.deleteContents();
              __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["f" /* applyRange */])(r);
            }
          }
        }
      }
    ...
    handleKeyDown: function handleKeyDown(e) {
      ...
      // todo: ←/→ 需要重置panel 并且不影响在at-chunk中直接回车
      // 但尚未解决 目前暂时是 左右重置
    ...
    scrollToCur: function scrollToCur() {
      ...
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["g" /* scrollIntoView */])(curEl, scrollParent);
    },
    selectByMouse: function selectByMouse(e) {
      var el = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["h" /* closest */])(e.target, function (d) {
    ...
    insertItem: function insertItem() {
      ...
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["f" /* applyRange */])(r);
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["f" /* applyRange */])(r);
      var t = itemName(list[cur]) + ' ';
      // document.execCommand('insertText', 0, t)
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__util__["b" /* insertText */])(t);
      this.handleInput();
    }
  }
});
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-05ccc8af!../node_modules/sass-loader/index.js!./At.scss", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-05ccc8af!../node_modules/sass-loader/index.js!./At.scss");
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__At_vue__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__At_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__At_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_textarea_caret__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_textarea_caret___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_textarea_caret__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  extends: __WEBPACK_IMPORTED_MODULE_0__At_vue___default.a,
  name: 'AtTextarea',
  ...
  methods: {
    handleDelete: function handleDelete(e) {
      ...
      if (text) {
        ...
        var _getAtAndIndex = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__util__["a" /* getAtAndIndex */])(text, atItems),
            at = _getAtAndIndex.at,
            index = _getAtAndIndex.index;
    ...
    handleInput: function handleInput() {
      ...
      if (text) {
        ...
        var _getAtAndIndex2 = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__util__["a" /* getAtAndIndex */])(text, atItems),
            at = _getAtAndIndex2.at,
            index = _getAtAndIndex2.index;
    ...
    openPanel: function openPanel(list, chunk, offset, at) {
      ...
      var fn = function fn() {
        ...
        var rect = __WEBPACK_IMPORTED_MODULE_1_textarea_caret___default()(el, atEnd);
        _this.atwho = {
          chunk: chunk,
          offset: offset,
          list: list,
    ...
    insertItem: function insertItem() {
      ...
      var _getAtAndIndex3 = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__util__["a" /* getAtAndIndex */])(text, atItems),
          at = _getAtAndIndex3.at,
          index = _getAtAndIndex3.index;
      ...
      var t = itemName(list[cur]) + ' ';
      // document.execCommand('insertText', 0, t)
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__util__["b" /* insertText */])(t, el);
      this.handleInput();
    }
  }
});
