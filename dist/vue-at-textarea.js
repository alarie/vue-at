...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    handleInput: function handleInput(keep) {
      ...
      if (range) {
        ...
        if (!show) {
          ...
          if (matched.length) {
            this.openPanel(matched, range, index, at, keep);
          } else {
            this.closePanel();
          }
        }
    ...
    openPanel: function openPanel(list, range, offset, at, keep) {
      var _this2 = this;
      ...
      var fn = function fn() {
        ...
        var lastCur = _this2.atwho && _this2.atwho.cur || 0;
        _this2.atwho = {
          range: range,
          offset: offset,
          list: list,
  ...
  methods: {
    ...
    openPanel: function openPanel(list, chunk, offset, at) {
      ...
      var fn = function fn() {
        ...
        var end = offset + at.length; // 从@后第一位开始
        var rect = __WEBPACK_IMPORTED_MODULE_1_textarea_caret___default()(el, end);
        _this.atwho = {
          chunk: chunk,
          offset: offset,
          list: list,
